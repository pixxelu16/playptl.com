@extends('layouts.role-profile', ['roleName' => 'Student', 'activeSection' => 'dashboard'])
...
@section('profile_panel')
    <div class="overflow-hidden rounded-[12px] bg-white p-6 shadow-[0_1px_8px_rgba(0,0,0,0.06)] ring-1 ring-[#E0E0E0] sm:p-8">
        <h3 class="mb-4 text-[20px] font-bold text-[#333333]">Welcome to your Student Dashboard</h3>
