...
@section('meta_description', 'View subgroup details from the admin dashboard.')
    ...
    <section class="admin-card">
        <div class="admin-page-header">
            <div>
                ...
                <p class="admin-card-text">Subgroup details and status.</p>
            </div>
        ...
        <div class="admin-detail-list admin-detail-list-wide">
            <div>
                <span>Subgroup Status</span>
                <strong>{{ ucfirst($group->status) }}</strong>
            </div>
            <div>
                <span>Subgroup Description</span>
