...
<div class="admin-form-grid">
    <div class="admin-form-group">
        <label class="admin-label" for="name">Group Name</label>
    ...
    <div class="admin-form-group">
        ...
        <input class="admin-input" id="players_count" type="number" name="players_count" min="0" value="{{ old('players_count', $group->players_count ?? 0) }}" required>
    </div>

    <div class="admin-form-group">
        <label class="admin-label" for="status">Group Status</label>
...
<div class="admin-form-group">
    <label class="admin-label" for="description">Group Description</label>
