...
@section('title', 'Add League | '.config('app.name', 'playptl'))
@section('meta_description', 'Create a new league from the admin dashboard.')

@section('content')
    <section class="admin-card">
        <div class="admin-page-header">
            <div>
                <h1 class="admin-card-title">Add League</h1>
                <p class="admin-card-text">Enter league details and upload a logo.</p>
            </div>
