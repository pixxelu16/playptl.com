...
@section('content')
    <main>
        ...
        <section class="site-hero relative flex flex-col overflow-hidden">
            <img class="absolute inset-0 z-0 h-full w-full object-cover" src="{{ asset(\App\Models\SiteSetting::banners()['coaches_banner_path']) }}" alt="Tennis Banner Background" aria-hidden="true">
