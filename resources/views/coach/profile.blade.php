@extends('layouts.role-profile', ['roleName' => 'Coach', 'activeSection' => 'profile'])
...
@section('profile_panel')
    ...
    <div class="overflow-hidden rounded-[12px] bg-white p-6 shadow-[0_1px_8px_rgba(0,0,0,0.06)] ring-1 ring-[#E0E0E0] sm:p-8">
        ...
        <form method="POST" action="{{ route('coach.profile.update') }}" class="space-y-4">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-4 pt-4 border-t border-gray-100">
                <h4 class="text-[16px] font-bold text-[#333333]">Coaching Profile Details</h4>

                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Title of your ad</label>
                    <textarea name="profile_title_ad" rows="3" placeholder="e.g. Professional tennis coach with 5 years experience..."
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">About your lessons</label>
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">About you and your achievements</label>
    ...
    <div class="overflow-hidden rounded-[12px] bg-white p-6 shadow-[0_1px_8px_rgba(0,0,0,0.06)] ring-1 ring-[#E0E0E0] sm:p-8 mt-6">
        ...
        <form method="POST" action="{{ route('coach.password.update') }}" class="space-y-4">
            @csrf
            @method('PUT')
